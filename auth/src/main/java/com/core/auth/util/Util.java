...
public class Util {
    public static String getRegisterEmailTemplate() {
        return "<!DOCTYPE html>\n" +
                "<html>\n" +
                "<head>\n" +
                "<style>\n" +
    ...
    public static String getResetPassword(){
        ...
        return "<!doctype html>\n" +
                ...
                "<strong style=\"font-size:24px;\">{{VERIFY_TOKEN}}</strong> <br/>\n" +
                "<p style=\"color:#455056; font-size:15px;line-height:24px; margin:0;\">\n" +
                "If this action wasn’t done by you, please contact us on <b>abilsabili50@gmail.com</b>. But if it’s you, you can ignore this message. </p>" +
                "</td>\n"+
                "</tr>\n"+
                "<tr>\n" +
                "<td style=\"height:40px;\">&nbsp;</td>" +
    ...
    public static boolean validateOTPFormat(String otp){
        if(otp.length() != 6) throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "invalid format otp");

        String regex = "\\d+";
        if(!otp.matches(regex)) throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "invalid format otp");
